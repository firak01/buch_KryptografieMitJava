...
//------------------------------------------------------------------------
  public  Twofish(String DatName) {			// Constructor encrypt	
    Datei P;
...
//-------------------------------------------------------------------------
  public Twofish(byte[] key, String DatName) {		// Constructor decrypt
    Datei P;
    P = new Datei(DatName);
...
//-------------------------------------------------------------------------
  public static void main (String[] arg) {
    Twofish makeTwofish;
    switch(arg.length) {
      case 0: makeTwofish = new Twofish("");			// encrypt
        break;
      case 1: makeTwofish = new Twofish(arg[0]);		// encrypt
        break;
      case 2: makeTwofish = new Twofish(Hex.fromString(arg[0]),arg[1]); // decrypt
        break;
    }
  }
}
